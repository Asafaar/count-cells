...
# Example usage
classified_folder = "./image-to-txt-images/weka"  # Folder with Weka classified images
original_images_folder = "./image-to-txt-images/orginal"  # Folder with original images
output_folder = "./image-to-txt-images/output"  # Folder to save YOLO annotations
